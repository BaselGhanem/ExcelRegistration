import{L as Pi,g as ki,i as Ri,a as vt,_ as $t,C as ht,r as jt,b as yn,S as Ce,E as Tt,c as g,d as p,e as Ai,h as wn,j as T,F as B,k as Si,q as de,l as Et,m as Kt,p as bi,n as ie,o as ye,s as vn,t as Ci,D as Ni,u as Oi,f as Pt,v as Tn,w as pt}from"./firebase-core-DKFvvrTN.js";const me={FACEBOOK:"facebook.com",GITHUB:"github.com",GOOGLE:"google.com",PASSWORD:"password",TWITTER:"twitter.com"},ne={EMAIL_SIGNIN:"EMAIL_SIGNIN",PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:"REVERT_SECOND_FACTOR_ADDITION",VERIFY_AND_CHANGE_EMAIL:"VERIFY_AND_CHANGE_EMAIL",VERIFY_EMAIL:"VERIFY_EMAIL"};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ze=new Pi("@firebase/auth");function kn(n,...e){ze.logLevel<=wn.WARN&&ze.warn(`Auth (${Ce}): ${n}`,...e)}function We(n,...e){ze.logLevel<=wn.ERROR&&ze.error(`Auth (${Ce}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ne{constructor(e,t){this.shortDelay=e,this.longDelay=t,b(t>e,"Short delay should be less than long delay!"),this.isMobile=Ri()||vt()}get(){return Ui()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zi(n){return(await I(n,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}async function Cn(n,e){return I(n,"GET","/v2/recaptchaConfig",_(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ae(n){var h;const e=n.auth,t=await n.getIdToken(),i=await x(n,Ge(e,{idToken:t}));l(i==null?void 0:i.users.length,e,"internal-error");const r=i.users[0];n._notifyReloadListener(r);const s=(h=r.providerUserInfo)!=null&&h.length?Nn(r.providerUserInfo):[],o=Yi(n.providerData,s),a=n.isAnonymous,c=!(n.email&&r.passwordHash)&&!(o!=null&&o.length),d=a?c:!1,u={uid:r.localId,displayName:r.displayName||null,photoURL:r.photoUrl||null,email:r.email||null,emailVerified:r.emailVerified||!1,phoneNumber:r.phoneNumber||null,tenantId:r.tenantId||null,providerData:o,metadata:new ft(r.createdAt,r.lastLoginAt),isAnonymous:d};Object.assign(n,u)}async function Ji(n){const e=p(n);await Ae(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Yi(n,e){return[...n.filter(i=>!e.some(r=>r.providerId===i.providerId)),...e]}function Nn(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xi(n,e){const t=await An(n,{},async()=>{const i=de({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=n.config,o=await Sn(n,r,"/v1/token",`key=${s}`),a=await n._getAdditionalHeaders();a["Content-Type"]="application/x-www-form-urlencoded";const c={method:"POST",headers:a,body:i};return n.emulatorConfig&&Et(n.emulatorConfig.host)&&(c.credentials="include"),Rn.fetch()(o,c)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Qi(n,e){return I(n,"POST","/v2/accounts:revokeToken",_(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,t){this.storage[e]=t}async _get(e){const t=this.storage[e];return t===void 0?null:t}async _remove(e){delete this.storage[e]}_addListener(e,t){}_removeListener(e,t){}}On.type="NONE";const ce=On;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function J(n,e,t){return`firebase:${n}:${e}:${t}`}class se{constructor(e,t,i){this.persistence=e,this.auth=t,this.userKey=i;const{config:r,name:s}=this.auth;this.fullUserKey=J(this.userKey,r.apiKey,s),this.fullPersistenceKey=J("persistence",r.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await Ge(this.auth,{idToken:e}).catch(()=>{});return t?S._fromGetAccountInfoResponse(this.auth,t,e):null}return S._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,i="authUser"){if(!t.length)return new se(R(ce),e,i);const r=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let s=r[0]||R(ce);const o=J(i,e.config.apiKey,e.name);let a=null;for(const d of t)try{const u=await d._get(o);if(u){let h;if(typeof u=="string"){const f=await Ge(e,{idToken:u}).catch(()=>{});if(!f)break;h=await S._fromGetAccountInfoResponse(e,f,u)}else h=S._fromJSON(e,u);d!==s&&(a=h),s=d;break}}catch{}const c=r.filter(d=>d._shouldAllowMigration);return!s._shouldAllowMigration||!c.length?new se(s,e,i):(s=c[0],a&&await s._set(o,a.toJSON()),await Promise.all(t.map(async d=>{if(d!==s)try{await d._remove(o)}catch{}})),new se(s,e,i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function en(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(Un(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(Ln(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Fn(e))return"Blackberry";if(Vn(e))return"Webos";if(Dn(e))return"Safari";if((e.includes("chrome/")||Mn(e))&&!e.includes("edge/"))return"Chrome";if(Oe(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if((i==null?void 0:i.length)===2)return i[1]}return"Other"}function Ln(n=T()){return/firefox\//i.test(n)}function Dn(n=T()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Mn(n=T()){return/crios\//i.test(n)}function Un(n=T()){return/iemobile/i.test(n)}function Oe(n=T()){return/android/i.test(n)}function Fn(n=T()){return/blackberry/i.test(n)}function Vn(n=T()){return/webos/i.test(n)}function Le(n=T()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Zi(n=T()){return/(iPad|iPhone|iPod).*OS 7_\d/i.test(n)||/(iPad|iPhone|iPod).*OS 8_\d/i.test(n)}function er(n=T()){var e;return Le(n)&&!!((e=window.navigator)!=null&&e.standalone)}function tr(){return vn()&&document.documentMode===10}function Wn(n=T()){return Le(n)||Oe(n)||Vn(n)||Fn(n)||/windows phone/i.test(n)||Un(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xn(n,e=[]){let t;switch(n){case"Browser":t=en(T());break;case"Worker":t=`${en(T())}-${n}`;break;default:t=n}const i=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${Ce}/${i}`}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let De={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function ar(n){De=n}function bt(n){return De.loadJS(n)}function cr(){return De.recaptchaV2Script}function lr(){return De.recaptchaEnterpriseScript}function dr(){return De.gapiScript}function Hn(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ur=500,hr=6e4,Ve=1e12;class pr{constructor(e){this.auth=e,this.counter=Ve,this._widgets=new Map}render(e,t){const i=this.counter;return this._widgets.set(i,new gr(e,this.auth.name,t||{})),this.counter++,i}reset(e){var i;const t=e||Ve;(i=this._widgets.get(t))==null||i.delete(),this._widgets.delete(t)}getResponse(e){var i;const t=e||Ve;return((i=this._widgets.get(t))==null?void 0:i.getResponse())||""}async execute(e){var i;const t=e||Ve;return(i=this._widgets.get(t))==null||i.execute(),""}}class fr{constructor(){this.enterprise=new mr}ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}class mr{ready(e){e()}execute(e,t){return Promise.resolve("token")}render(e,t){return""}}class gr{constructor(e,t,i){this.params=i,this.timerId=null,this.deleted=!1,this.responseToken=null,this.clickHandler=()=>{this.execute()};const r=typeof e=="string"?document.getElementById(e):e;l(r,"argument-error",{appName:t}),this.container=r,this.isVisible=this.params.size!=="invisible",this.isVisible?this.execute():this.container.addEventListener("click",this.clickHandler)}getResponse(){return this.checkIfDeleted(),this.responseToken}delete(){this.checkIfDeleted(),this.deleted=!0,this.timerId&&(clearTimeout(this.timerId),this.timerId=null),this.container.removeEventListener("click",this.clickHandler)}execute(){this.checkIfDeleted(),!this.timerId&&(this.timerId=window.setTimeout(()=>{this.responseToken=_r(50);const{callback:e,"expired-callback":t}=this.params;if(e)try{e(this.responseToken)}catch{}this.timerId=window.setTimeout(()=>{if(this.timerId=null,this.responseToken=null,t)try{t()}catch{}this.isVisible&&this.execute()},hr)},ur))}checkIfDeleted(){if(this.deleted)throw new Error("reCAPTCHA mock was already deleted!")}}function _r(n){const e=[],t="1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";for(let i=0;i<n;i++)e.push(t.charAt(Math.floor(Math.random()*t.length)));return e.join("")}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zn(n,e){return I(n,"POST","/v1/accounts:resetPassword",_(n,e))}async function Pr(n,e){return I(n,"POST","/v1/accounts:update",e)}async function kr(n,e){return I(n,"POST","/v1/accounts:signUp",e)}async function Rr(n,e){return I(n,"POST","/v1/accounts:update",_(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gn(n,e){return H(n,"POST","/v1/accounts:signUp",_(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Gr(n,e){const t=p(n);await Qe(!0,t,e);const{providerUserInfo:i}=await Bi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=$n(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function Ct(n,e,t=!1){const i=await x(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function Qe(n,e,t){await Ae(e);const i=$n(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";l(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Kn(n,e,t=!1){if(g(n.app))return Promise.reject(v(n));const i="signIn",r=await Bn(n,i,e),s=await A._fromIdTokenResponse(n,i,r);return t||await n._updateCurrentUser(s.user),s}async function Ze(n,e){return Kn(m(n),e)}async function Jn(n,e){const t=p(n);return await Qe(!1,t,e.providerId),Ct(t,e)}async function Yn(n,e){return jn(p(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Lt(n){const e=m(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function jr(n,e,t){const i=m(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&et(i,r,t),await $(i,r,"getOobCode",br,"EMAIL_PASSWORD_PROVIDER")}async function Kr(n,e,t){await zn(p(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Lt(n),i})}async function Jr(n,e){await Rr(p(n),{oobCode:e})}async function Xn(n,e){const t=p(n),i=await zn(t,{oobCode:e}),r=i.requestType;switch(l(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":l(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":l(i.mfaInfo,t,"internal-error");default:l(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=Me._fromServerResponse(m(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function Yr(n,e){const{data:t}=await Xn(p(n),e);return t.email}async function Xr(n,e,t){if(g(n.app))return Promise.reject(v(n));const i=m(n),o=await $(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",Gn,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Lt(n),c}),a=await A._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function Qr(n,e,t){return g(n.app)?Promise.reject(v(n)):Ze(p(n),j.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&Lt(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ds(n){var r,s;if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},i=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&(n!=null&&n.idToken)){const o=(s=(r=Je(n.idToken))==null?void 0:r.firebase)==null?void 0:s.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new ae(i,a)}}if(!e)return null;switch(e){case"facebook.com":return new us(i,t);case"github.com":return new hs(i,t);case"google.com":return new ps(i,t);case"twitter.com":return new fs(i,t,n.screenName||null);case"custom":case"anonymous":return new ae(i,null);default:return new ae(i,e,t)}}class ae{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class Zn extends ae{constructor(e,t,i,r){super(e,t,i),this.username=r}}class us extends ae{constructor(e,t){super(e,"facebook.com",t)}}class hs extends Zn{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class ps extends ae{constructor(e,t){super(e,"google.com",t)}}class fs extends Zn{constructor(e,t,i){super(e,"twitter.com",t,i)}}function ms(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:ds(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ei{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(je,"1"),this.storage.removeItem(je),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ni extends ei{constructor(){super(()=>window.sessionStorage,"SESSION")}_addListener(e,t){}_removeListener(e,t){}}ni.type="SESSION";const X=ni;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tt{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const t=this.receivers.find(r=>r.isListeningto(e));if(t)return t;const i=new tt(e);return this.receivers.push(i),i}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const t=e,{eventId:i,eventType:r,data:s}=t.data,o=this.handlersMap[r];if(!(o!=null&&o.size))return;t.ports[0].postMessage({status:"ack",eventId:i,eventType:r});const a=Array.from(o).map(async d=>d(t.origin,s)),c=await Ts(a);t.ports[0].postMessage({status:"done",eventId:i,eventType:r,response:c})}_subscribe(e,t){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(t)}_unsubscribe(e,t){this.handlersMap[e]&&t&&this.handlersMap[e].delete(t),(!t||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}tt.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dn(n,e){return I(n,"POST","/v2/accounts/mfaSignIn:start",_(n,e))}function Ls(n,e){return I(n,"POST","/v2/accounts/mfaSignIn:finalize",_(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ct=Hn("rcb"),Ds=new Ne(3e4,6e4);class Ms{constructor(){var e;this.hostLanguage="",this.counter=0,this.librarySeparatelyLoaded=!!((e=y().grecaptcha)!=null&&e.render)}load(e,t=""){return l(Us(t),e,"argument-error"),this.shouldResolveImmediately(t)&&Yt(y().grecaptcha)?Promise.resolve(y().grecaptcha):new Promise((i,r)=>{const s=y().setTimeout(()=>{r(w(e,"network-request-failed"))},Ds.get());y()[ct]=()=>{y().clearTimeout(s),delete y()[ct];const a=y().grecaptcha;if(!a||!Yt(a)){r(w(e,"internal-error"));return}const c=a.render;a.render=(d,u)=>{const h=c(d,u);return this.counter++,h},this.hostLanguage=t,i(a)};const o=`${cr()}?${de({onload:ct,render:"explicit",hl:t})}`;bt(o).catch(()=>{clearTimeout(s),r(w(e,"internal-error"))})})}clearedOneInstance(){this.counter--}shouldResolveImmediately(e){var t;return!!((t=y().grecaptcha)!=null&&t.render)&&(e===this.hostLanguage||this.counter>0||this.librarySeparatelyLoaded)}}function Us(n){return n.length<=6&&/^\s*[a-zA-Z0-9\-]*\s*$/.test(n)}class Fs{async load(e){return new pr(e)}clearedOneInstance(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{constructor(e,t){this.verificationId=e,this.onConfirmation=t}confirm(e){const t=Y._fromVerification(this.verificationId,e);return this.onConfirmation(t)}}async function Hs(n,e,t){if(g(n.app))return Promise.reject(v(n));const i=m(n),r=await it(i,e,p(t));return new Vt(r,s=>Ze(i,s))}async function qs(n,e,t){const i=p(n);await Qe(!1,i,"phone");const r=await it(i.auth,e,p(t));return new Vt(r,s=>Jn(i,s))}async function zs(n,e,t){const i=p(n);if(g(i.auth.app))return Promise.reject(v(i.auth));const r=await it(i.auth,e,p(t));return new Vt(r,s=>Yn(i,s))}async function it(n,e,t){var i;if(!n._getRecaptchaConfig())try{await yr(n)}catch{console.log("Failed to initialize reCAPTCHA Enterprise config. Triggering the reCAPTCHA v2 verification.")}try{let r;if(typeof e=="string"?r={phoneNumber:e}:r=e,"session"in r){const s=r.session;if("phoneNumber"in r){l(s.type==="enroll",n,"internal-error");const o={idToken:s.credential,phoneEnrollmentInfo:{phoneNumber:r.phoneNumber,clientType:"CLIENT_TYPE_WEB"}};return(await $(n,o,"mfaSmsEnrollment",async(u,h)=>{if(h.phoneEnrollmentInfo.captchaResponse===Te){l((t==null?void 0:t.type)===Ee,u,"argument-error");const f=await lt(u,h,t);return an(u,f)}return an(u,h)},"PHONE_PROVIDER").catch(u=>Promise.reject(u))).phoneSessionInfo.sessionInfo}else{l(s.type==="signin",n,"internal-error");const o=((i=r.multiFactorHint)==null?void 0:i.uid)||r.multiFactorUid;l(o,n,"missing-multi-factor-info");const a={mfaPendingCredential:s.credential,mfaEnrollmentId:o,phoneSignInInfo:{clientType:"CLIENT_TYPE_WEB"}};return(await $(n,a,"mfaSmsSignIn",async(h,f)=>{if(f.phoneSignInInfo.captchaResponse===Te){l((t==null?void 0:t.type)===Ee,h,"argument-error");const te=await lt(h,f,t);return dn(h,te)}return dn(h,f)},"PHONE_PROVIDER").catch(h=>Promise.reject(h))).phoneResponseInfo.sessionInfo}}else{const s={phoneNumber:r.phoneNumber,clientType:"CLIENT_TYPE_WEB"};return(await $(n,s,"sendVerificationCode",async(d,u)=>{if(u.captchaResponse===Te){l((t==null?void 0:t.type)===Ee,d,"argument-error");const h=await lt(d,u,t);return sn(d,h)}return sn(d,u)},"PHONE_PROVIDER").catch(d=>Promise.reject(d))).sessionInfo}}finally{t==null||t._reset()}}async function Gs(n,e){const t=p(n);if(g(t.auth.app))return Promise.reject(v(t.auth));await Ct(t,e)}async function lt(n,e,t){l(t.type===Ee,n,"argument-error");const i=await t.verify();l(typeof i=="string",n,"argument-error");const r={...e};if("phoneEnrollmentInfo"in r){const s=r.phoneEnrollmentInfo.phoneNumber,o=r.phoneEnrollmentInfo.captchaResponse,a=r.phoneEnrollmentInfo.clientType,c=r.phoneEnrollmentInfo.recaptchaVersion;return Object.assign(r,{phoneEnrollmentInfo:{phoneNumber:s,recaptchaToken:i,captchaResponse:o,clientType:a,recaptchaVersion:c}}),r}else if("phoneSignInInfo"in r){const s=r.phoneSignInInfo.captchaResponse,o=r.phoneSignInInfo.clientType,a=r.phoneSignInInfo.recaptchaVersion;return Object.assign(r,{phoneSignInInfo:{recaptchaToken:i,captchaResponse:s,clientType:o,recaptchaVersion:a}}),r}else return Object.assign(r,{recaptchaToken:i}),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ai{constructor(e,t,i,r,s=!1){this.auth=e,this.resolver=i,this.user=r,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(i){this.reject(i)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:i,postBody:r,tenantId:s,error:o,type:a}=e;if(o){this.reject(o);return}const c={auth:this.auth,requestUri:t,sessionId:i,tenantId:s||void 0,postBody:r||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(a)(c))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Bs;case"linkViaPopup":case"linkViaRedirect":return js;case"reauthViaPopup":case"reauthViaRedirect":return $s;default:E(this.auth,"internal-error")}}resolve(e){b(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){b(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Qs="pendingRedirect",Pe=new Map;class Zs extends ai{constructor(e,t,i=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,i),this.eventId=null}async execute(){let e=Pe.get(this.auth._key());if(!e){try{const i=await eo(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(i)}catch(t){e=()=>Promise.reject(t)}Pe.set(this.auth._key(),e)}return this.bypassAuthState||Pe.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function eo(n,e){const t=li(e),i=ci(n);if(!await i._isAvailable())return!1;const r=await i._get(t)==="true";return await i._remove(t),r}async function xt(n,e){return ci(n)._set(li(e),"true")}function to(){Pe.clear()}function Ht(n,e){Pe.set(n._key(),e)}function ci(n){return R(n._redirectPersistence)}function li(n){return J(Qs,n.config.apiKey,n.name)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function no(n,e,t){return io(n,e,t)}async function io(n,e,t){if(g(n.app))return Promise.reject(v(n));const i=m(n);ue(n,e,q),await i._initializationPromise;const r=ee(i,t);return await xt(r,i),r._openRedirect(i,e,"signInViaRedirect")}function ro(n,e,t){return so(n,e,t)}async function so(n,e,t){const i=p(n);if(ue(i.auth,e,q),g(i.auth.app))return Promise.reject(v(i.auth));await i.auth._initializationPromise;const r=ee(i.auth,t);await xt(r,i.auth);const s=await di(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function oo(n,e,t){return ao(n,e,t)}async function ao(n,e,t){const i=p(n);ue(i.auth,e,q),await i.auth._initializationPromise;const r=ee(i.auth,t);await Qe(!1,i,e.providerId),await xt(r,i.auth);const s=await di(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function co(n,e){return await m(n)._initializationPromise,rt(n,e,!1)}async function rt(n,e,t=!1){if(g(n.app))return Promise.reject(v(n));const i=m(n),r=ee(i,e),o=await new Zs(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function di(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lo=600*1e3;class ui{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(i=>{this.isEventForConsumer(e,i)&&(t=!0,this.sendToConsumer(e,i),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!uo(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var i;if(e.error&&!hi(e)){const r=((i=e.error.code)==null?void 0:i.split("auth/")[1])||"internal-error";t.onError(w(this.auth,r))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const i=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&i}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=lo&&this.cachedEventUids.clear(),this.cachedEventUids.has(un(e))}saveEventToCache(e){this.cachedEventUids.add(un(e)),this.lastProcessedEventTime=Date.now()}}function un(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function hi({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function uo(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return hi(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pi(n,e={}){return I(n,"GET","/v1/projects",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lo="__/auth/handler",Do="emulator/auth/handler",Mo=encodeURIComponent("fac");async function mt(n,e,t,i,r,s){l(n.config.authDomain,n,"auth-domain-config-required"),l(n.config.apiKey,n,"invalid-api-key");const o={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:i,v:Ce,eventId:r};if(e instanceof q){e.setDefaultLanguage(n.languageCode),o.providerId=e.providerId||"",Ci(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,h]of Object.entries(s||{}))o[u]=h}if(e instanceof pe){const u=e.getScopes().filter(h=>h!=="");u.length>0&&(o.scopes=u.join(","))}n.tenantId&&(o.tid=n.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await n._getAppCheckToken(),d=c?`#${Mo}=${encodeURIComponent(c)}`:"";return`${Uo(n)}?${de(a).slice(1)}${d}`}function Uo({config:n}){return n.emulator?St(n,Do):`https://${n.authDomain}/${Lo}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt="webStorageSupport";class Fo{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=X,this._completeRedirectFn=rt,this._overrideRedirectResult=Ht}async _openPopup(e,t,i,r){var o;b((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const s=await mt(e,t,i,Re(),r);return No(e,s,Ue())}async _openRedirect(e,t,i,r){await this._originValidation(e);const s=await mt(e,t,i,Re(),r);return Ps(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:r,promise:s}=this.eventManagers[t];return r?Promise.resolve(r):(b(s,"If manager is not set, promise should be"),s)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch(()=>{delete this.eventManagers[t]}),i}async initAndGetManager(e){const t=await ko(e),i=new ui(e);return t.register("authEvent",r=>(l(r==null?void 0:r.authEvent,e,"invalid-auth-event"),{status:i.onEvent(r.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(dt,{type:dt},r=>{var o;const s=(o=r==null?void 0:r[0])==null?void 0:o[dt];s!==void 0&&t(!!s),E(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=fo(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Wn()||Dn()||Le()}}const Vo=Fo;class Wo{constructor(e){this.factorId=e}_process(e,t,i){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,i);case"signin":return this._finalizeSignIn(e,t.credential);default:return D("unexpected MultiFactorSessionType")}}}class qt extends Wo{constructor(e){super("phone"),this.credential=e}static _fromCredential(e){return new qt(e)}_finalizeEnroll(e,t,i){return _s(e,{idToken:t,displayName:i,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return Ls(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}}class fi{constructor(){}static assertion(e){return qt._fromCredential(e)}}fi.FACTOR_ID="phone";var fn="@firebase/auth",mn="1.13.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bo=2e3;async function $o(n,e,t){const{BuildInfo:i}=Z();b(e.sessionId,"AuthEvent did not contain a session ID");const r=await Xo(e.sessionId),s={};return Le()?s.ibi=i.packageName:Oe()?s.apn=i.packageName:E(n,"operation-not-supported-in-this-environment"),i.displayName&&(s.appDisplayName=i.displayName),s.sessionId=r,mt(n,t,e.type,void 0,e.eventId??void 0,s)}async function jo(n){const{BuildInfo:e}=Z(),t={};Le()?t.iosBundleId=e.packageName:Oe()?t.androidPackageName=e.packageName:E(n,"operation-not-supported-in-this-environment"),await pi(n,t)}function Ko(n){const{cordova:e}=Z();return new Promise(t=>{e.plugins.browsertab.isAvailable(i=>{let r=null;i?e.plugins.browsertab.openUrl(n):r=e.InAppBrowser.open(n,Zi()?"_blank":"_system","location=yes"),t(r)})})}async function Jo(n,e,t){const{cordova:i}=Z();let r=()=>{};try{await new Promise((s,o)=>{let a=null;function c(){var f;s();const h=(f=i.plugins.browsertab)==null?void 0:f.close;typeof h=="function"&&h(),typeof(t==null?void 0:t.close)=="function"&&t.close()}function d(){a||(a=window.setTimeout(()=>{o(w(n,"redirect-cancelled-by-user"))},Bo))}function u(){(document==null?void 0:document.visibilityState)==="visible"&&d()}e.addPassiveListener(c),document.addEventListener("resume",d,!1),Oe()&&document.addEventListener("visibilitychange",u,!1),r=()=>{e.removePassiveListener(c),document.removeEventListener("resume",d,!1),document.removeEventListener("visibilitychange",u,!1),a&&window.clearTimeout(a)}})}finally{r()}}function Yo(n){var t,i,r,s,o,a,c,d,u,h;const e=Z();l(typeof((t=e==null?void 0:e.universalLinks)==null?void 0:t.subscribe)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-universal-links-plugin-fix"}),l(typeof((i=e==null?void 0:e.BuildInfo)==null?void 0:i.packageName)<"u",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-buildInfo"}),l(typeof((o=(s=(r=e==null?void 0:e.cordova)==null?void 0:r.plugins)==null?void 0:s.browsertab)==null?void 0:o.openUrl)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),l(typeof((d=(c=(a=e==null?void 0:e.cordova)==null?void 0:a.plugins)==null?void 0:c.browsertab)==null?void 0:d.isAvailable)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),l(typeof((h=(u=e==null?void 0:e.cordova)==null?void 0:u.InAppBrowser)==null?void 0:h.open)=="function",n,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-inappbrowser"})}async function Xo(n){const e=Qo(n),t=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(t)).map(r=>r.toString(16).padStart(2,"0")).join("")}function Qo(n){if(b(/[0-9a-zA-Z]+/.test(n),"Can only convert alpha-numeric strings"),typeof TextEncoder<"u")return new TextEncoder().encode(n);const e=new ArrayBuffer(n.length),t=new Uint8Array(e);for(let i=0;i<n.length;i++)t[i]=n.charCodeAt(i);return t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aa=500;class ca{constructor(){this._redirectPersistence=X,this._shouldInitProactively=!0,this.eventManagers=new Map,this.originValidationPromises={},this._completeRedirectFn=rt,this._overrideRedirectResult=Ht}async _initialize(e){const t=e._key();let i=this.eventManagers.get(t);return i||(i=new ea(e),this.eventManagers.set(t,i),this.attachCallbackListeners(e,i)),i}_openPopup(e){E(e,"operation-not-supported-in-this-environment")}async _openRedirect(e,t,i,r){Yo(e);const s=await this._initialize(e);await s.initialized(),s.resetRedirect(),to(),await this._originValidation(e);const o=ta(e,i,r);await na(e,o);const a=await $o(e,o,t),c=await Ko(a);return Jo(e,s,c)}_isIframeWebStorageSupported(e,t){throw new Error("Method not implemented.")}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=jo(e)),this.originValidationPromises[t]}attachCallbackListeners(e,t){const{universalLinks:i,handleOpenURL:r,BuildInfo:s}=Z(),o=setTimeout(async()=>{await gn(e),t.onEvent(_n())},aa),a=async u=>{clearTimeout(o);const h=await gn(e);let f=null;h&&(u!=null&&u.url)&&(f=ia(h,u.url)),t.onEvent(f||_n())};typeof i<"u"&&typeof i.subscribe=="function"&&i.subscribe(null,a);const c=r,d=`${s.packageName.toLowerCase()}://`;Z().handleOpenURL=async u=>{if(u.toLowerCase().startsWith(d)&&a({url:u}),typeof c=="function")try{c(u)}catch(h){console.error(h)}}}}const la=ca;function _n(){return{type:"unknown",eventId:null,sessionId:null,urlResponse:null,postBody:null,tenantId:null,error:w("no-auth-event")}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function da(n,e){m(n)._logFramework(e)}var ua="@firebase/auth-compat",ha="0.6.9";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const k={LOCAL:"local",NONE:"none",SESSION:"session"},_e=l,Ii="persistence";function va(n,e){if(_e(Object.values(k).includes(e),n,"invalid-persistence-type"),vt()){_e(e!==k.SESSION,n,"unsupported-persistence-type");return}if(Tn()){_e(e===k.NONE,n,"unsupported-persistence-type");return}if(zt()){_e(e===k.NONE||e===k.LOCAL&&pt(),n,"unsupported-persistence-type");return}_e(e===k.NONE||gi(),n,"unsupported-persistence-type")}async function It(n){await n._initializationPromise;const e=yi(),t=J(Ii,n.config.apiKey,n.name);e&&e.setItem(t,n._getPersistenceType())}function Ta(n,e){const t=yi();if(!t)return[];const i=J(Ii,n,e);switch(t.getItem(i)){case k.NONE:return[ce];case k.LOCAL:return[be,X];case k.SESSION:return[X];default:return[]}}function yi(){var n;try{return((n=wa())==null?void 0:n.sessionStorage)||null}catch{return null}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wi(n){return n.unwrap()}function Pa(n){return n.wrapped()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ie=l;class wt{constructor(e,t){if(this.app=e,t.isInitialized()){this._delegate=t.getImmediate(),this.linkUnderlyingAuth();return}const{apiKey:i}=e.options;Ie(i,"invalid-api-key",{appName:e.name}),Ie(i,"invalid-api-key",{appName:e.name});const r=typeof window<"u"?G:void 0;this._delegate=t.initialize({options:{persistence:Sa(i,e.name),popupRedirectResolver:r}}),this._delegate._updateErrorMap(Di),this.linkUnderlyingAuth()}get emulatorConfig(){return this._delegate.emulatorConfig}get currentUser(){return this._delegate.currentUser?V.getOrCreate(this._delegate.currentUser):null}get languageCode(){return this._delegate.languageCode}set languageCode(e){this._delegate.languageCode=e}get settings(){return this._delegate.settings}get tenantId(){return this._delegate.tenantId}set tenantId(e){this._delegate.tenantId=e}useDeviceLanguage(){this._delegate.useDeviceLanguage()}signOut(){return this._delegate.signOut()}useEmulator(e,t){vr(this._delegate,e,t)}applyActionCode(e){return Jr(this._delegate,e)}checkActionCode(e){return Xn(this._delegate,e)}confirmPasswordReset(e,t){return Kr(this._delegate,e,t)}async createUserWithEmailAndPassword(e,t){return P(this._delegate,Xr(this._delegate,e,t))}fetchProvidersForEmail(e){return this.fetchSignInMethodsForEmail(e)}fetchSignInMethodsForEmail(e){return is(this._delegate,e)}isSignInWithEmailLink(e){return es(this._delegate,e)}async getRedirectResult(){Ie(ut(),this._delegate,"operation-not-supported-in-this-environment");const e=await co(this._delegate,G);return e?P(this._delegate,Promise.resolve(e)):{credential:null,user:null}}addFrameworkForLogging(e){da(this._delegate,e)}onAuthStateChanged(e,t,i){const{next:r,error:s,complete:o}=In(e,t,i);return this._delegate.onAuthStateChanged(r,s,o)}onIdTokenChanged(e,t,i){const{next:r,error:s,complete:o}=In(e,t,i);return this._delegate.onIdTokenChanged(r,s,o)}sendSignInLinkToEmail(e,t){return Zr(this._delegate,e,t)}sendPasswordResetEmail(e,t){return jr(this._delegate,e,t||void 0)}async setPersistence(e){va(this._delegate,e);let t;switch(e){case k.SESSION:t=X;break;case k.LOCAL:t=await R(be)._isAvailable()?be:Ut;break;case k.NONE:t=ce;break;default:return E("argument-error",{appName:this._delegate.name})}return this._delegate.setPersistence(t)}signInAndRetrieveDataWithCredential(e){return this.signInWithCredential(e)}signInAnonymously(){return P(this._delegate,zr(this._delegate))}signInWithCredential(e){return P(this._delegate,Ze(this._delegate,e))}signInWithCustomToken(e){return P(this._delegate,$r(this._delegate,e))}signInWithEmailAndPassword(e,t){return P(this._delegate,Qr(this._delegate,e,t))}signInWithEmailLink(e,t){return P(this._delegate,ts(this._delegate,e,t))}signInWithPhoneNumber(e,t){return yt(this._delegate,Hs(this._delegate,e,t))}async signInWithPopup(e){return Ie(ut(),this._delegate,"operation-not-supported-in-this-environment"),P(this._delegate,Js(this._delegate,e,G))}async signInWithRedirect(e){return Ie(ut(),this._delegate,"operation-not-supported-in-this-environment"),await It(this._delegate),no(this._delegate,e,G)}updateCurrentUser(e){return this._delegate.updateCurrentUser(e)}verifyPasswordResetCode(e){return Yr(this._delegate,e)}unwrap(){return this._delegate}_delete(){return this._delegate._delete()}linkUnderlyingAuth(){this._delegate.wrapped=()=>this}}wt.Persistence=k;function In(n,e,t){let i=n;typeof n!="function"&&({next:i,error:e,complete:t}=n);const r=i;return{next:o=>r(o&&V.getOrCreate(o)),error:e,complete:t}}function Sa(n,e){const t=Ta(n,e);if(typeof self<"u"&&!t.includes(be)&&t.push(be),typeof window<"u")for(const i of[Ut,X])t.includes(i)||t.push(i);return t.includes(ce)||t.push(ce),t}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gt{static credential(e,t){return Q.credential(e,t)}constructor(){this.providerId="phone",this._delegate=new Q(wi(Pt.auth()))}verifyPhoneNumber(e,t){return this._delegate.verifyPhoneNumber(e,t)}unwrap(){return this._delegate}}Gt.PHONE_SIGN_IN_METHOD=Q.PHONE_SIGN_IN_METHOD;Gt.PROVIDER_ID=Q.PROVIDER_ID;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
